...
Define some extra theme bits:

```{r}
#| echo: true
labels <- list(ylab("Percent"),
               xlab(""),
               ggtitle("Favorite Halloween Candy of US Population"),
               guides(fill = "none", color = "none"))
...
```{r}
#| echo: true
ggplot(candy_short, aes(x = candy, y = overall, fill = candy)) +
  geom_col() + 
  labels
